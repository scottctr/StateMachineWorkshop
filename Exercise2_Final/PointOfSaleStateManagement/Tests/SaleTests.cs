...
namespace PointOfSaleStateManagement.Tests
{
    public class SaleTests
    {
        ...
        public void Test_8_can_cancel()
        {
            ...
            Assert.True(sut.IsComplete, "Successfully cancelled sale not marked cancelled");
        }
        ...
        public void Test_8a_cannot_cancel_sale_with_payment_balance()
        {
            ...
            Assert.False(sut.IsComplete, "Successfully cancelled sale not marked cancelled");
        }
